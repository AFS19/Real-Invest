...
<head>
    ...
    <!-- Favicons -->
    <link href="/faveicon.jpg" rel="icon">
                            ...
                            <div class="card-overlay card-overlay-hover">
                                ...
                                <div class="card-body-d">
                                    ...
                                    <div class="info-agents color-a">
                                        <p>
                                            <strong>Phone: </strong> +212649910261
                                        </p>
                                        <p>
                                            <strong>Email: </strong> realinvest@invest.com
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div class="widget-a">
                        ...
                        <div class="w-footer-a">
                            <ul class="list-unstyled">
                                ...
                                <li class="color-a">
                                    <span class="color-text-a">Address:</span> {{ config('company.address') }}
                                </li>
                                <li class="color-a">
                                    <span class="color-text-a">City:</span> {{ config('company.city') }}
                                </li>
                            </ul>
                        </div>
                    </div>
